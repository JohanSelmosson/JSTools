function Resolve-SPFRecord {
    #Source: https://cloudbrothers.info/en/powershell-tip-resolve-spf/
    #Changes: 
    # * Support for just returning number of lookups
    # * Possible fix of handling of mx-includes
    # * removed unnecessary warnings for "~all" or "v=spfv1"
    [CmdletBinding()]
    param (
        # Domain Name
        ...
        # Just return how may dns-lookups that were required
        [Parameter()]
        [switch]
        $ReturnNumberOfDNSLookups
